...
namespace TicketingApp
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            builder.Services.AddHttpClient("TicketingApp.Api", client =>
            {
            ...
            builder.Services.AddTransient(sp => sp.GetRequiredService<IHttpClientFactory>().CreateClient("TicketingApp.Api"));
